# Hardware Abstration Layer for the Nordic nRF9120

This crate is a Hardware Abstraction Layer (HAL) for the Nordic nRF9161/nRF9151/nRF9131. It
wraps the PAC (`nrf9120-pac`) and provides high level wrappers for the chip's
peripherals.
